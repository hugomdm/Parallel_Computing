...
microbenchmark(forest.fire(infection_matrix, .2, .4, FALSE), 
...
#The best performances was the vectorized implementation and the rcpp one, that manage to reduce significantly the time of execution. 
